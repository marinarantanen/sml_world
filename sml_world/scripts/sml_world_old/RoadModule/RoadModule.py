...
import RoadAuxClasses  # Defines the necessary container classes for OSM structures
...
class RoadModule(object):
    ...
    def __init__(self, map_file_location, image_width = 1920., image_height = 1080., image_pixel_per_meter = 5.):
