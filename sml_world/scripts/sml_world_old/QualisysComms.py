...
class QualisysComms(object):

    def __init__(self, host = 'sml-qualisys.ddns.net', port = 22224, verbose = False):
        #set IP and PORT of the Qtm PC

        self.qualisys_host = host

        self.qualisys_port = port
        self.port = port
    ...
    def _create_connection(self):
        ...
        try:
            ...
            s.connect((self.qualisys_host , self.qualisys_port))  
        ...
        if self.verbose:
            ...
            print 'Socket Connected on host ' + self.qualisys_host + ', port ' + str(self.qualisys_port) + '\n'
    ...
    def find_available_bodies(self):
        ...
        if len(valid) == 0 and self.verbose:
    ...
    def get_updated_bodies(self):
        ...
        try:
            ...
            [valid_bodies,bodies_info] = self.find_available_bodies()
        ...
        for body in valid_bodies:
            ...
            bodies_dict[new_pose['id']] = new_pose
...
#     Qs = QualisysComms(verbose=True)
#     bodies = Qs.find_available_bodies(verbose=1)
